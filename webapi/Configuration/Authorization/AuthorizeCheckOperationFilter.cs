...
namespace CopilotChat.WebApi.Configuration.Authorization;

public class AuthorizeCheckOperationFilter : IOperationFilter
{
    private readonly CopilotApiConfiguration _copilotApiConfiguration;

    public AuthorizeCheckOperationFilter(CopilotApiConfiguration copilotApiConfiguration)
    {
            ...
            operation.Security = new List<OpenApiSecurityRequirement>
                {
                    new OpenApiSecurityRequirement
                    {
                        ...
                        ] = new[] { this._copilotApiConfiguration.OidcApiName }
                    }
                };
